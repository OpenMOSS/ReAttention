...
tags = [
    ...
    ('-reattn-32.4x32.4096.512-gu-clip127', 'llama3_8b', 'llama', '{prompt}', 
    ...
    ('-reattn-32.4x32.8192.512-hu-clip256', 'llama3_1_8b', 'llama+', '{prompt}', 
    ...
    ('-reattn-32.4x32.8192.512-hu-clip256', 'llama3_2_3b', 'llama+', '{prompt}', 
        {'global_size': 32, 'mid_size': 4, 'span_size': 32, 'local_size': 8192, 'chunk_size': 512, 
        'recall_type': 'qk', 'pe_original': False, 'q_cache_len': 0, 
        'rope_scaling': None, 'recall_option': 'default', 'unique_option': 'head_unique', 
        'key_compress_ratio': 1, 'value_compress_ratio': 1, 'recall_clip': 256, }), 
    ...
    ('-reattn-32.4x32.8192.512-hu-clip256', 'mistral3_7b', 'mistral', '{prompt}', 
        {'global_size': 32, 'mid_size': 4, 'span_size': 32, 'local_size': 8192, 'chunk_size': 512, 
        'recall_type': 'qk', 'pe_original': False, 'q_cache_len': 0, 
        'rope_scaling': None, 'recall_option': 'default', 'unique_option': 'head_unique', 
        'key_compress_ratio': 1, 'value_compress_ratio': 1, 'recall_clip': 256, }), 
    ...
    ('-reattn-32.4x32.8192.512-hu-clip256', 'internlm2_5_7b', 'internlm2', '{prompt}', 
        {'global_size': 32, 'mid_size': 4, 'span_size': 32, 'local_size': 8192, 'chunk_size': 512, 
        'recall_type': 'qk', 'pe_original': False, 'q_cache_len': 0, 
        'rope_scaling': None, 'recall_option': 'default', 'unique_option': 'head_unique', 
        'key_compress_ratio': 1, 'value_compress_ratio': 1, 'recall_clip': 256, }), 
    ...
    ('-reattn-32.4x32.8192.512-hu-clip256', 'qwen2_5_7b', 'qwen2', '{prompt}', 
        {'global_size': 32, 'mid_size': 4, 'span_size': 32, 'local_size': 8192, 'chunk_size': 512, 
        'recall_type': 'qk', 'pe_original': False, 'q_cache_len': 0, 
        'rope_scaling': None, 'recall_option': 'default', 'unique_option': 'head_unique', 
        'key_compress_ratio': 1, 'value_compress_ratio': 1, 'recall_clip': 256, }), 
    ...
    ('-reattn-32.4x32.8192.512-hu-clip256', 'qwen2_5_1b', 'qwen2', '{prompt}', 
        {'global_size': 32, 'mid_size': 4, 'span_size': 32, 'local_size': 8192, 'chunk_size': 512, 
        'recall_type': 'qk', 'pe_original': False, 'q_cache_len': 0, 
        'rope_scaling': None, 'recall_option': 'default', 'unique_option': 'head_unique', 
        'key_compress_ratio': 1, 'value_compress_ratio': 1, 'recall_clip': 256, }), 
...
for abbr, group, model_type, prompt_format, re_attn_config in tags:
...
# python run.py eval_xrliu/eval_reattn_niah.py --dump-eval-details -r --debug
# python run.py eval_xrliu/eval_reattn_niah.py --dump-eval-details -r
